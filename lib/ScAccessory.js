    ...
    if ((beat - this.initialBeat) % 120 === 0) {
      ...
      try {
        ...
        if (this.notYetInitialised) {
          if (this.client.u1) {
            this.values.model = 'SOMA Connect U1'
          }
          ...
          const recommendedVersion = packageJson.engines[this.client.u1 ? 'soma-u1' : 'soma-connect']
        ...
        for (const id in this.shades) {
          try {
            ...
            shade.batteryService.values.batteryLevel =
